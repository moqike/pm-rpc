...
var Client = /** @class */ (function () {
    function Client(options) {
        ...
        this._callbackMap = {};
        this._serializeArgument = function (argument) {
            var _a, _b;
            var result = argument;
            if (Array.isArray(argument)) {
                result = argument.map(_this._serializeArgument);
            }
            else if (argument && typeof argument === 'object') {
                if (argument.hasOwnProperty(types_1.RPC_ARG_TYPE_KEY)) {
                    ...
                    for (var key in argument) {
                        result[key] = _this._serializeArgument(argument[key]);
                    }
                }
            }
            return result;
    ...
    Client.prototype.invoke = function (provider, method, args, options) {
        ...
        var serializedArguments = this._serializeArgument(args);
